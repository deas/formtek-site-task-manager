function main()
{
    ...
    var wfId = decodeURIComponent(url.templateArgs["wfId"]);
    var site = decodeURIComponent(url.templateArgs["site"]);
    
    // Check user access rights
    if( !ftkworkflow.canEdit(wfId, site) )
    {
        // Authentication error.  Report an error
        //   User must be a site manager, administrator or the initiator of the workflow
        //    to be able to update properties of a site workflow task
        status.setCode(401, "Not Authenticated");
        return;
    }
