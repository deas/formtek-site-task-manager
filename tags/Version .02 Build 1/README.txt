...
you'll also need to have the Alfresco 4.0.2 SDK downloaded.

In the root level of the source for the dashlet project, you will find the file build.properties.
...
But other command-line build options are available.
